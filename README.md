...
按提示輸入同事姓名、公司職級（如 `IC 設計廠 資深後端工程師`）、性格標籤，然後選擇資料來源。所有欄位均可跳過，僅憑描述也能生成。
...
> 輸入：`IC 設計廠 資深後端工程師，INTJ，甩鍋高手，IC 設計廠風`
...
**企業文化**：半導體大廠風 · IC 設計廠風 · 跨國科技風 · 傳產轉型風 · 外商風 · 電商平台風 · 第一性原理 · OKR 狂熱者 · 科技業流水線 · 新創風

**職級支援**：
- 半導體大廠（工程師 → 資深 → 主任 → 副理 → 經理 → 處長）
