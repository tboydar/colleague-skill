...
company:     公司名稱                    # 可選，如：半導體大廠 / IC 設計廠 / 跨國科技公司 / Google / 電商平台
level:       職級                       # 可選，如：資深工程師 / 主任工程師 / L5 / Senior
role:        職位名稱                   # 可選，如：演算法工程師 / 產品經理 / 前端工程師
# 三者合併示例："IC 設計廠 資深 後端工程師" / "半導體大廠 主任工程師" / "Google L5 產品經理"
...
- `半導體大廠風` — 紀律嚴明、流程導向、追求良率與效率、講究 SOP 與規範
- `IC 設計廠風` — 技術導向、務實低調、強調執行力、Cost-down 思維
- `跨國科技風` — 國際化視野、資安專業、注重團隊合作與技術深度
- `外商風` — 扁平組織、英文溝通、重視 work-life balance、用 OKR 管理
- `傳產轉型風` — 層級分明、重視年資、流程繁複、穩定至上
- `電商平台風` — 極致執行、摳細節、電商營運思維、快速迭代
...
**半導體大廠**：工程師 → 資深工程師 → 主任工程師 → 副理 → 經理 → 處長

**IC 設計廠**：工程師 → 資深 → 主任 → 經理 → 處長

**外商（Google/Meta/MS）**：L3~L8 / SDE I~III → Senior → Staff → Principal

**跨國科技公司**：Engineer → Senior → Staff → Principal
...
**跨公司對照範例**：
```
IC 設計廠 資深工程師 ≈ 半導體大廠 資深工程師 ≈ 外商 L4/IC3 ≈ 一般科技業 Senior
IC 設計廠 主任工程師 ≈ 半導體大廠 主任工程師 ≈ 外商 L5/Senior ≈ 一般科技業 Lead
IC 設計廠 經理 ≈ 半導體大廠 副理~經理 ≈ 外商 L6/Staff
```
